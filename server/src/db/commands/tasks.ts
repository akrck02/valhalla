...
export class TasksResponse implements HTTPResponse {
   ...
   * @returns a promise
   */
  public static searchTasksByName(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @param res The HTTP response
   */
  public static searchCategoriesByName(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @return a promise
   */
  public static getUserDoneTasks(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @returns a promise
   */
  public static async getUserTasksFromCategory(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
    ...
    let tasks = await TaskModel.getUserTasksFromCategory(
      db,
      username,
      category,
    );
  ...
  public static async getUserMonthTasks(
    ...
    const response = await TaskModel.getUserMonthTasks(
      db,
      username,
      year,
      month,
   ...
   * @returns a promise
   */
  public static async getUserTaskCategories(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
    ...
    const taskWithoutCategory = await TaskModel.getUserTasksWithoutCategory(
      db,
      username,
    );
   ...
   * @returns a promise
   */
  public static async insertUserTask(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @param res The HTTP response
   */
  public static setTagToUserTask(
    db: Database,
    req: Request,
    res: Response,
  ): void {}
   ...
   * @returns a promise
   */
  public static async deleteUserTask(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @returns a promise
   */
  public static async deleteUserTasks(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @returns a promise
   */
  public static async updateUserTaskDone(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
   ...
   * @returns a promise
   */
  public static async updateUserTasksDone(
    db: Database,
    req: Request,
    res: Response,
  ): Promise<any> {
