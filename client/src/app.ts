...
} from "./components/notifications/notification.js";
...
export class App {
  ...
  constructor() {
    ...
    console.log(
      Configurations.BASE.APP_NAME +
        " " +
        Configurations.BASE.APP_VERSION +
        " is loaded!",
    );
  }
  ...
  public loadFromUrl(): void {
    ...
    if (titleElement)
      titleElement.onclick = () =>
        (location.href = Configurations.VIEWS.BASE_URL);
