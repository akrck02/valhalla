...
export function CALENDAR_TODAY(properties) {
    properties.svg = ` 
...
export function TASK_ALT(properties) {
    properties.svg = ` 
...
export function TUNE(properties) {
    properties.svg = ` 
