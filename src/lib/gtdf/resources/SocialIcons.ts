 ...
 */ 
export function getSocialIcon(name: string , properties: SocialIconsProperties): UIComponent {
 ...
 */
export function createSVG(properties: SocialIconsProperties): string {
    const svg = `
