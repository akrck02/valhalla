export default class URLs {
     ...
     */
    public static getParametersByBreakPoint (url: string, breakpoint: string) : string[] {
     ...
     */
    public static getParametersByIndex (url: string, index: number) : string[]{
        let params = url.split("/");
        params = params.slice(index, params.length);
        return params;
    };
     ...
     */
    public static downloadFile(uri: string, name: string){
     ...
     */
    public static getUrlGetParameters(url: string) : object {
        let params = url.split("?");
